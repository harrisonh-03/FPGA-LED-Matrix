...
HD_PWD='C:/Users/harri/Desktop/Vivado Projects/matrix_solid/matrix_solid.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log solidMatrix.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source solidMatrix.tcl -notrace

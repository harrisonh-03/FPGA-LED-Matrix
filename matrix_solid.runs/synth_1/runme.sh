...
HD_PWD='C:/Users/harri/Desktop/Vivado Projects/matrix_solid/matrix_solid.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log solidMatrix.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source solidMatrix.tcl
